...
extern "C" 
{
	...
	MACHINELEARNING_DLL_API double* LinearFitClassificationRosenblatt(double* model, double* inputs, int inputsSize, int inputSize, double* outputs, int outputSize);
